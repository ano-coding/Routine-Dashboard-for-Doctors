            ...
            >
              <DialogPanel className="relative flex transform flex-col items-center gap-10 overflow-hidden rounded-[24px] bg-white px-6 pb-6 shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                ...
                <div className="mt-5 flex flex-col items-center gap-3">
                  ...
                  /person3.png"
                  />
                  <div className="font-dm-sans text-[15px] font-medium leading-[24px] tracking-[0.15px]">
                    Dr. Pooja
                  </div>
                  <div className="text-center font-dm-sans text-[14px] leading-[20px] text-neutral-500">
                    {isAssigned
